...
void render(void)
{
	...
	glColor3f(1, 1, 1);
	drawStrokeText((char*)"Move and rotate the squares to the right position, shown in the ", 0, 20, 0);
	drawStrokeText((char*)"top left corner. ", 0,40, 0);
	drawStrokeText((char*)"Move the squares with WASD, rotate them with Q & E.", 0, 80, 0);
	drawStrokeText((char*)"Change the square being controlled with Z & X, the selected square", 0, 100, 0);
	drawStrokeText((char*)"has a slightly green tint.", 0, 120, 0);
	drawStrokeText((char*)"The squares turn green when in the correct position.", 0, 160, 0);
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Instructions"); //Instruction window
